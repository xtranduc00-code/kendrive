...
import { getDriveFiles, getDriveTotalSpaceUsed } from "@/lib/actions/drive.actions";
import { convertFileSize, getUsageSummary } from "@/lib/utils";
import type { DriveFileDisplay } from "@/lib/google-drive";

const Dashboard = async () => {
  const [filesRes, totalSpace] = await Promise.all([
  ...
  const usageSummary = getUsageSummary(totalSpaceSafe);

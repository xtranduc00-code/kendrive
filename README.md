...
**Set Up Environment Variables (Google Drive)**

This app uses **Google Sign-In** and **Google Drive API** (no Appwrite). Create `.env.local` in the project root:
...
# Create OAuth 2.0 Client ID (Web). Enable Drive API.
